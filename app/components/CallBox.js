        ...
        <View style={styles.mainContainer}>
          <View style={styles.headerContainer}>
            <View style={styles.leftHeaderContainer}>
              ...
              <Text style={styles.nameText}>{this.props.navigation.state.params.name === undefined ? 'Anonymous' : this.props.navigation.state.params.name}</Text>
              <Text style={[styles.callingText, {marginTop: 5}]}>CALLING</Text>
            </View>
          </View>
          <View style={styles.contentContainer}>
            <ImageBackground source={{uri:this.props.navigation.state.params.image}} style={{flex: 1, backgroundColor: 'gray'}}>
              <View style={{flex: 1}}/>
          ...
          <View style={styles.footerContainer}>
            ...
            <TouchableOpacity onPress={() => this.props.navigation.navigate("ChatBox", { image:this.props.navigation.state.params.image, name:this.props.navigation.state.params.name })}>
