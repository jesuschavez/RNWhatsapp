...
class ContactSelection extends Component {
  ...
  _nextScreen(person) {
    if(this.props.type === 'chats'){
      this.props.navigation.navigate("ChatBox", {image:this.props.navigation.state.params.person.image, name: this.props.navigation.state.params.person.first_name})
    } else if(this.props.type === 'calls'){
      this.props.navigation.navigate("CallBox", {image: this.props.navigation.state.params.person.image, name: this.props.navigation.state.params.person.first_name})
    }
  }
