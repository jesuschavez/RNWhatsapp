...
class Contacts extends Component {
  ...
  render(){
      if(this.state.loaded) {
        ...
        return (<Text onPress= {() => {this.props.navigation.navigate("ChatBox") }}>Retrieving Contacts...</Text>)
      }
  }

  _renderPersonRow(person){
    return(
      <TouchableOpacity onPress={() => {this.props.navigation.navigate("ChatBox", {image:person.image, name: person.first_name}) }}>
